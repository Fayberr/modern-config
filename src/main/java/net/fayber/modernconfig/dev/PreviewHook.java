...
public final class PreviewHook {
    ...
    public static ModernConfigScreen demoScreen() {
        ...
        return ModernConfigScreen.builder(Component.literal("Modern Config Preview"), null, () -> {
                })
                .category("General")
                ...
                .enabledWhen(() -> s.beamEnabled)
                .tooltip("Only meaningful while the beam is on.")
                ...
                .error(() -> s.defaultName.isBlank() ? "Quick-added waypoints need a name." : null)
