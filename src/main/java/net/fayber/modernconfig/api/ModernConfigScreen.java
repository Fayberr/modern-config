...
/**
 * A Modern Config screen: a dimmed backdrop with a centred column of option cards floating
...
public class ModernConfigScreen extends Screen {
    ...
    /** Fluent builder: {@code ModernConfigScreen.builder(title, parent, onSave).category(...)...build()}. */
